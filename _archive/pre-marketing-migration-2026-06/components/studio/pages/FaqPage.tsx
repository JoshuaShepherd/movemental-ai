...
const FAQ_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "case-studies", q: "Where are your case studies?", a: <>Named case studies are in development. The honest in-development page lives at <Link href="/case-studies" className="text-primary hover:underline">/case-studies</Link> &mdash; it names what doesn&rsquo;t yet exist and points to the three substantive reading paths in the meantime: the <Link href="/field-guides" className="text-primary hover:underline">field guides</Link> (what we teach), the <Link href="/movement-leaders" className="text-primary hover:underline">Movement Leaders</Link> directory (who walks alongside this work), and the founders&rsquo; longer arc on <Link href="/about" className="text-primary hover:underline">About</Link>. Specific named clients come once we have permission to publish them, not before.</> },
