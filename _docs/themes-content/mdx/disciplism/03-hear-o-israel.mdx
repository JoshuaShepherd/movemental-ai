...
sectionSlug: "hear-o-israel"
sectionTitle: "Hear O Israel"
sectionType: "chapter"
sectionOrder: 3
sectionNumber: "3"
prevSection: "a-church-equal-to-the-game"
nextSection: "make-consumers-of-all-nations"
sourceFile: ""
format: "mdx"
version: "1.0"
...
So in this chapter, let's go back to the Great Commission itself, let's look at it with fresh eyes.
...
Fourth, the apostles are called to baptize people into the name of the Triune God.

This is a radically inclusive call to the nations to join God’s covenant family.

They are then told, “… Teach them to observe all that I have commanded you.” Obedience is the only appropriate response to the reign of Jesus. Clearly, teaching people what it means to obey is not the same as getting decisions for Christ at an altar call or praying the sinner’s prayer. This is another indisputable disciplemaking motif.
...
So now let me ask again: Where exactly do we see “evangelism” mentioned here?

There is no overt mention of it at all. In fact, the text explicitly binds us to the practices of discipleship and disciple making. It turns out that the Great Commission is not actually about evangelism but rather disciple making.
