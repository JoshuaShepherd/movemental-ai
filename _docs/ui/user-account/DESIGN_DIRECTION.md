...
### Pattern 4: Forum/Community Profile Stats
- **Source(s)**: `retool-profile-stats-badges.png`, `coinbase-profile-stats-activity.png`
- **What it solves**: Shows user engagement metrics and activity history
- **Implementation guidance**:
  - **Stats row**: Days visited, read time, topics viewed, posts read
  - **Engagement metrics**: Likes given, likes received
  ...
  - Trust level or member status display
  - Profile header with avatar, name, role/title

### Pattern 5: Creator Profile Edit Modal
- **Source(s)**: `buymeacoffee-profile-edit-modal.png`
- **What it solves**: Simple modal for editing public profile information
- **Implementation guidance**:
  - Modal overlay with Cancel/Save header
  - Circular avatar with camera overlay for upload
  - Form fields: Full name, tagline, About me (rich text)
  - Featured video URL field
  - Social links with add/remove functionality
...
| `retool-profile-stats-badges.png` | Retool | Profile stats, activity summary, badges, community engagement | P2 |
| `buymeacoffee-profile-edit-modal.png` | Buy Me a Coffee | Profile edit modal, avatar upload, rich text bio | P1 |
| `coinbase-profile-stats-activity.png` | Coinbase | Profile stats, top links, activity metrics | P2 |
