...
import { Inter, Playfair_Display, IBM_Plex_Mono, Caveat } from "next/font/google";
...
/** Ink Band hand face — Caveat for margins and notes. */
const caveat = Caveat({
...
export default async function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${playfairDisplay.variable} ${ibmPlexMono.variable} ${caveat.variable} h-full min-h-dvh antialiased`}
      suppressHydrationWarning
    >
      <body className="flex min-h-dvh flex-col bg-background text-foreground ink-band-surface">
        <Providers>
