...
export function AboutMissionValues({ className }: AboutMissionValuesProps) {
  return (
    <section className={cn("relative w-full", className)}>
      {/* Mission Hero */}
      <div className="px-6 sm:px-12 lg:px-20 py-24 bg-mvmt-surface-light">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs font-bold tracking-widest uppercase mb-4 text-mvmt-accent">
            Our Mission
          </p>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-mvmt-text-primary font-mvmt-heading">
            Equipping leaders who start movements that matter
          </h1>
          <p className="text-lg leading-relaxed text-mvmt-text-secondary">
      ...
      {/* Divider */}
      <div className="h-px bg-mvmt-border-light" />

      {/* Values Grid */}
      <div className="px-6 sm:px-12 lg:px-20 py-20 bg-mvmt-surface-light-muted">
        <h2 className="text-xl font-bold mb-12 text-center text-mvmt-text-primary font-mvmt-heading">
          What We Believe
        </h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-5xl mx-auto">
          {values.map((v) => (
            <div key={v.title}>
              ...
              <h3 className="text-base font-bold mb-2 text-mvmt-text-primary">{v.title}</h3>
      ...
      {/* Bottom Quote */}
      <div className="px-6 sm:px-12 lg:px-20 py-16 text-center bg-mvmt-surface-light">
        <blockquote className="max-w-2xl mx-auto">
          <p className="text-xl italic leading-relaxed mb-4 text-mvmt-text-primary">
            &ldquo;The future belongs to movements — and movements belong to the people who start them.&rdquo;
          </p>
          <cite className="text-sm not-italic font-medium text-mvmt-text-muted">
            — Brad Brisco, Founder
          </cite>
        </blockquote>
      </div>
