...
export function AboutSplitMedia({ className }: AboutSplitMediaProps) {
  return (
    <section className={cn("relative w-full", className)}>
        ...
        >
          ...
          <div
            className={cn(
              ...
              "bg-mvmt-surface-light"
            )}
          >
            <p className="text-xs font-bold tracking-widest uppercase mb-3 text-mvmt-accent">
              {s.label}
            </p>
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-mvmt-text-primary font-mvmt-heading">
              {s.title}
            </h2>
          ...
          >
            <div className="text-center px-8">
              <div className="w-20 h-20 rounded-lg mx-auto mb-4 flex items-center justify-center bg-mvmt-surface-dark">
                <span className="text-2xl font-bold text-mvmt-on-dark-primary">
                  {String(i + 1).padStart(2, "0")}
                </span>
              </div>
              <p className="text-xs uppercase tracking-wider text-mvmt-text-muted">
                Image Placeholder
              </p>
            </div>
          </div>
      ...
      {/* CTA */}
      <div className="px-6 sm:px-12 lg:px-20 py-12 text-center border-t border-mvmt-border-light bg-mvmt-surface-light">
        <a
          href="/pricing"
