  ...
  return (
    ...
    >
      ...
      <div className="text-center pt-4 pb-2">
        <span className="text-xs font-semibold text-mvmt-text-primary">Your Leadership</span>
      </div>
      ...
      {/* Content */}
      <div className="flex-1 flex flex-col items-center px-6 sm:px-8 lg:px-12 max-w-lg mx-auto bg-mvmt-surface-light-muted">
        <h1
          className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4 text-mvmt-text-primary font-mvmt-heading"
        >
        ...
        <div className="w-48 h-48 mb-8 flex items-center justify-center">
          <svg viewBox="0 0 120 120" className="w-full h-full text-mvmt-text-primary">
        ...
        {/* CTA */}
        <button
          className="w-full max-w-sm py-4 rounded-lg text-base font-medium transition-colors text-mvmt-cta-text bg-mvmt-cta-bg"
        >
          Continue
        </button>
      </div>
