    ...
    >
      <div className="w-full max-w-sm">
        ...
        <label className="block mb-4">
          <span className="text-xs font-medium mb-1.5 block text-[var(--mvmt-on-dark-secondary)]">Email</span>
          <input
            type="email"
        ...
        <label className="block mb-2">
          <span className="text-xs font-medium mb-1.5 block text-[var(--mvmt-on-dark-secondary)]">Password</span>
          <input
            type="password"
            placeholder="••••••••"
            className="w-full px-3 py-2.5 text-sm rounded-md border outline-none transition-colors bg-[var(--mvmt-surface-dark-elevated)] border-[var(--mvmt-border-dark)] text-[var(--mvmt-on-dark-primary)] placeholder:text-[var(--mvmt-on-dark-muted)] focus:border-[var(--mvmt-accent)]"
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-xs text-[var(--mvmt-on-dark-muted)]">or</span>
          <div className="flex-1 h-px bg-[var(--mvmt-border-dark)]" />
        </div>

        <button className="w-full py-2.5 text-sm font-medium rounded-md border transition-colors mb-3 border-[var(--mvmt-border-dark)] text-[var(--mvmt-on-dark-primary)] bg-[var(--mvmt-surface-dark-elevated)] hover:opacity-90">
          Continue with Google
        </button>
        <button className="w-full py-2.5 text-sm font-medium rounded-md border transition-colors border-[var(--mvmt-border-dark)] text-[var(--mvmt-on-dark-primary)] bg-[var(--mvmt-surface-dark-elevated)] hover:opacity-90">
