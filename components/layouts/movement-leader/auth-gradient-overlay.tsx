  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        {/* Card */}
        <div className="rounded-xl p-8 border shadow-lg bg-[var(--mvmt-surface-light)] border-[var(--mvmt-border-light)]">
          {/* Logo */}
          <div className="text-center mb-8">
            <div className="w-10 h-10 rounded-lg mx-auto mb-3 flex items-center justify-center bg-[var(--mvmt-accent)]">
              <span className="text-sm font-bold text-[var(--mvmt-cta-text)]">M</span>
            </div>
          ...
          {/* Social */}
          <button className="w-full py-2.5 text-sm font-medium rounded-lg border transition-colors mb-2.5 border-[var(--mvmt-border-light)] text-[var(--mvmt-text-primary)] hover:bg-[var(--mvmt-surface-light-muted)]">
          ...
          <p className="text-xs mt-6 text-center text-[var(--mvmt-text-muted)]">
            ...
            <Link href="/signup" className="text-[var(--mvmt-accent)] hover:underline">Sign up free</Link>
          </p>
        </div>

        <p className="text-2xs mt-4 text-center text-[var(--mvmt-on-dark-secondary)]">
