  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        {/* Logo */}
        <div className="mb-10">
          <h1 className="text-2xl font-bold text-[var(--mvmt-text-primary)] font-mvmt-heading">
            Log in
          </h1>
          <p className="text-sm mt-1 text-[var(--mvmt-text-secondary)]">
        ...
        <div className="space-y-2.5 mb-6">
          <button className="w-full py-3 text-sm font-medium rounded-md border transition-colors flex items-center justify-center gap-3 border-[var(--mvmt-border-light)] text-[var(--mvmt-text-primary)] hover:bg-[var(--mvmt-surface-light-muted)]">
        ...
        <div className="pt-6 border-t border-[var(--mvmt-border-light)]">
          <label className="block mb-4">
            <span className="text-xs font-medium mb-1.5 block text-[var(--mvmt-text-secondary)]">
              Or enter your email
            </span>
            <input
              type="email"
        ...
        <p className="text-xs mt-3 text-center text-[var(--mvmt-text-muted)]">
          New to Movemental?{" "}
