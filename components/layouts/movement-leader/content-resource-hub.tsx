...
export function ContentResourceHub({ className }: ContentResourceHubProps) {
  const resources = [
    { title: "Getting Started Guide", description: "Everything you need to launch your first missional community on the platform.", color: "#3B82F6", bgLight: "#DBEAFE" },
    { title: "Video Library", description: "Hours of training content from Alan Hirsch, Dave Ferguson, Brad Brisco, and more.", color: "#8B5CF6", bgLight: "#EDE9FE" },
    { title: "Templates & Playbooks", description: "Ready-made frameworks for coaching sessions, community rhythms, and leader pipelines.", color: "#10B981", bgLight: "#D1FAE5" },
    { title: "Community Forum", description: "Connect with other movement leaders. Ask questions, share wins, and find collaborators.", color: "#F59E0B", bgLight: "#FEF3C7" },
    { title: "Webinar Archive", description: "Recordings of live events, Q&A sessions, and expert panels on multiplication topics.", color: "#EF4444", bgLight: "#FEE2E2" },
    { title: "API Documentation", description: "Technical reference for integrating Movemental with your existing ministry tools.", color: "#6366F1", bgLight: "#E0E7FF" },
  ];
