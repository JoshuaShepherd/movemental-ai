  ...
  return (
    <section className={cn("relative w-full flex flex-col", className)} style={{ backgroundColor: "var(--mvmt-surface-dark)" }}>
      ...
      <div className="px-6 sm:px-12 lg:px-16 py-12 text-center">
        <p className="text-sm font-bold mb-8" style={{ color: "var(--mvmt-on-dark-primary)" }}>
          Trusted by the best in the business
        </p>
        <div className="flex items-center justify-center gap-12 flex-wrap">
          {logos.map((name) => (
            <span key={name} className="text-lg font-bold opacity-60" style={{ color: "var(--mvmt-on-dark-primary)" }}>
              {name}
            </span>
          ))}
        </div>
      ...
      <div className="mx-6 sm:mx-12 lg:mx-16" style={{ borderBottom: "1px solid var(--mvmt-border-on-dark)" }} />

      {/* Testimonial */}
      <div className="px-6 sm:px-12 lg:px-16 py-16 text-center max-w-3xl mx-auto">
        <p className="text-sm font-bold tracking-wider mb-6" style={{ color: "var(--mvmt-on-dark-primary)" }}>
          NAMB
        </p>
        <blockquote
        ...
        <div className="w-6 h-1 mx-auto mb-4" style={{ backgroundColor: "var(--mvmt-accent)" }} />
        <p className="text-xs" style={{ color: "var(--mvmt-on-dark-muted)" }}>
      ...
      <div className="px-6 sm:px-12 lg:px-16 py-16">
        <h2
          className="text-2xl sm:text-3xl md:text-4xl font-bold max-w-3xl"
          style={{ color: "var(--mvmt-on-dark-primary)", fontFamily: "var(--mvmt-font-heading)" }}
        >
