...
export function ReaderEbookDark({ className }: ReaderEbookDarkProps) {
  return (
    <section className={cn("relative w-full min-h-[70vh] md:min-h-[80vh] flex items-center justify-center", className)} style={{ backgroundColor: "var(--mvmt-surface-dark)" }}>
      {/* Reader Modal */}
      <div
        className="w-full max-w-5xl mx-4 rounded-lg overflow-hidden flex flex-col"
        style={{ backgroundColor: "var(--mvmt-surface-light)", minHeight: "70vh" }}
      >
        {/* Top Bar */}
        <div className="flex items-center justify-between px-6 py-3" style={{ borderBottom: "1px solid var(--mvmt-border-light)" }}>
          <button className="flex items-center gap-2 text-sm" style={{ color: "var(--mvmt-text-secondary)" }}>
            ‹ Back to store
          </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm" style={{ color: "var(--mvmt-text-muted)" }}>Aa</span>
          </div>
        </div>
        ...
        <div className="flex-1 px-8 sm:px-16 md:px-24 py-10 grid md:grid-cols-2 gap-8">
          <div>
            <h3
              className="text-sm font-bold tracking-[0.3em] text-center mb-8"
              style={{ color: "var(--mvmt-text-primary)" }}
            >
              PROLOGUE
            </h3>
            <p className="text-sm leading-[1.8] text-justify" style={{ color: "var(--mvmt-text-primary)", fontFamily: "var(--mvmt-font-heading)" }}>
              <span className="text-5xl font-bold float-left mr-2 leading-none" style={{ color: "var(--mvmt-text-primary)" }}>I</span>n the next twenty-four months, our church will be sending our first team to plant in a new city. I don&rsquo;t know how this could be happening. I&rsquo;m not the kind of pastor who sends planters. I&rsquo;m <em>not</em>. I&rsquo;ve never even attended a church planting conference. I&rsquo;ve never even thought about multiplication before. I&rsquo;m the most traditional pastor who ever was.
            </p>
            <p className="text-sm leading-[1.8] text-justify mt-4" style={{ color: "var(--mvmt-text-primary)", fontFamily: "var(--mvmt-font-heading)" }}>
        ...
        <div className="px-8 sm:px-16 md:px-24 pb-6">
          ...
          <p className="text-xs text-center" style={{ color: "var(--mvmt-text-muted)" }}>
