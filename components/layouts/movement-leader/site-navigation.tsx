...
const templatePages = [
  ...
  { label: "Auth", href: "/templates/auth" },
  ...
  { label: "FAQ", href: "/templates/faq" },
  { label: "Lead Magnet", href: "/templates/lead-magnet" },
  { label: "Misc", href: "/templates/misc" },
  { label: "Pricing", href: "/templates/pricing" },
  { label: "Reader", href: "/templates/reader" },
  { label: "Search", href: "/templates/search" },
  { label: "Special", href: "/templates/special" },
