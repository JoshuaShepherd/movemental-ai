...
export const ONBOARDING_PHASES: OnboardingPhase[] = [
  {
    ...
    description: 'We start by understanding who you are, your movement context, and your vision. This phase aligns your identity with what Movemental can do.',
    ...
    activities: [
      {
        ...
        description: 'Your movement theology, leadership style, and voice',
      },
      {
        id: 'd2',
        title: 'Movement Context Mapping',
        description: 'Your network, audience, and influence',
      },
      {
        id: 'd3',
        title: 'Business Model Alignment',
        description: 'Revenue streams, pricing, sustainability',
      },
      {
        id: 'd4',
        title: 'Vision Documentation',
        description: 'Your goals, success metrics, and platform vision',
      },
    ],
    status: 'upcoming',
  },
  {
    ...
    description: 'Our AI analyzes your existing content to understand your voice, themes, and audience. Your platform ends up reflecting your actual work.',
    ...
    activities: [
      {
        ...
        description: 'AI review of your sermons, articles, talks, and social content',
      },
      {
        id: 'r2',
        title: 'Theme & Topic Extraction',
        description: 'Core themes, recurring topics, and distinct perspectives',
      },
      {
        id: 'r3',
        title: 'Network Intelligence',
        description: 'Connections to other movement leaders for cross-pollination',
      },
      {
        id: 'r4',
  ...
  },
  {
    ...
    description: 'You join the Movemental network and launch—with content already on the platform and connection to other movement leaders.',
