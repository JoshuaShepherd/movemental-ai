...
import { IntegrityDiagnosticForm } from '@/components/IntegrityDiagnosticForm';
        ...
        <Container>
          <Reveal>
            ...
            <div className="hero-actions flex flex-wrap gap-4 mb-16">
              ...
              <Link to="/field-guide" className="btn-pill border border-inverse-border text-inverse-foreground hover:bg-inverse-foreground/10">Read the field guide first</Link>
            </div>
      ...
      <section className="band-default" id="when">
        <Container>
          <Reveal>
            ...
            <Link to="/field-guide" className="btn-pill btn-pill--ghost">Read the field guide for the full Sequence</Link>
          </Reveal>
        </Container>
      </section>
      ...
      <section className="band-section" id="faq">
        <Container>
          <Reveal>
            ...
            <Link to="/faq" className="btn-pill btn-pill--ghost">See the full FAQ</Link>
          </Reveal>
        </Container>
      </section>
        ...
        <Container width="narrow">
          <Reveal>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/contact" className="btn-pill border border-inverse-border text-inverse-foreground hover:bg-inverse-foreground/10">Start a conversation first</Link>
            </div>
          </Reveal>
        </Container>
      </section>
