          ...
          <Reveal>
            ...
            <form onSubmit={handleSubmit} className="bg-card border border-border p-8 md:p-12 rounded-2xl shadow-xl shadow-border/10 space-y-8 relative overflow-hidden group">
              ...
              <div className="pt-4 flex flex-col items-end gap-4 border-t border-border mt-8">
                ...
                <p className="text-xs text-muted-foreground max-w-sm text-right">By submitting this form, you agree to our <Link to="/privacy" className="text-primary hover:underline">Privacy Policy</Link> and <Link to="/terms" className="text-primary hover:underline">Terms of Service</Link>.</p>
              </div>
            </form>
          </Reveal>
        </Container>
