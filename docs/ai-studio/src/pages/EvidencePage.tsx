        ...
        <Container>
          <Reveal>
            ...
            <div className="hero-actions flex flex-wrap gap-4">
              ...
              <Link to="/contact" className="btn-pill border border-inverse-border text-inverse-foreground hover:bg-inverse-foreground/10">Talk With Us</Link>
            </div>
          </Reveal>
        </Container>
      </section>
        ...
        <Container>
          <Reveal>
            ...
            <p className="prose max-w-[640px] text-[1.0625rem] leading-[1.75] text-muted-foreground mb-12">
               Our conviction is that moving out of this sequence is what causes failure. Rushing to Solutions without Safety causes breaches.
            </p>
      ...
      <section className="band-section" id="people">
         <Container>
            <Reveal>
               ...
               <Link to="/team" className="btn-pill btn-pill--ghost">Meet the team</Link>
            </Reveal>
         </Container>
      </section>
