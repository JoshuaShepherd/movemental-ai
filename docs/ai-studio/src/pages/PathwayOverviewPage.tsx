            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-primary/5 border border-primary/20 p-8 rounded-2xl relative overflow-hidden flex flex-col justify-center">
                  ...
                  <Link to="/contact" className="btn-pill btn-pill--primary text-center">Discuss a full Pathway engagement</Link>
                </div>
              </div>
            </div>
          </Reveal>
        ...
        <Container>
          <Reveal>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Link to="/contact" className="btn-pill btn-pill--ghost text-sm">Talk about a Network Engagement</Link>
            </div>
          </Reveal>
        </Container>
      </section>
        ...
        <Reveal>
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/pathway/foundations" className="btn-pill btn-pill--primary">Start with Safety Documentation</Link>
              <Link to="/contact" className="btn-pill btn-pill--ghost">Talk to us about the full Pathway</Link>
            </div>
          </div>
        </Reveal>
      </Container>
