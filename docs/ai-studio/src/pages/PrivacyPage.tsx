    ...
    <div className="py-24">
      <Container width="narrow">
        <div className="prose prose-neutral max-w-none">
          ...
          <h3 className="font-bold mt-4 mb-2">Information you provide</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold mt-4 mb-2">Automatic information</h3>
          <p className="mb-4">
          ...
          <p className="mb-4">
             We use strictly necessary cookies to run our site. Please see our <Link to="/cookies" className="text-primary hover:underline">Cookie Policy</Link> for details.
          </p>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4">Legal bases</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4">How we share</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4">Retention</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4">International</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
             If you have questions about this policy, please reach out via our <Link to="/contact" className="text-primary hover:underline">Contact page</Link>.
          </p>
        </div>
      </Container>
    </div>
