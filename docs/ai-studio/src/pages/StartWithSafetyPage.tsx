        ...
        <Container>
          <Reveal>
            ...
            <div className="hero-actions flex flex-wrap gap-4">
              <Link to="/contact" className="btn-pill bg-[#FDFBF7] text-[#101828] hover:bg-[#E5E0D8]">Begin the Safety Step</Link>
      ...
      <section className="band-default" id="path">
        <Container>
          <Reveal>
            ...
            <Link to="/field-guide" className="btn-pill btn-pill--ghost">See the full path</Link>
          </Reveal>
        </Container>
      </section>
