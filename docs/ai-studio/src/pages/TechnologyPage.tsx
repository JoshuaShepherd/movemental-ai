        ...
        <Reveal>
          <div className="max-w-4xl mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-16">
              <Link to="/contact?interest=Build" className="btn-pill btn-pill--primary">Book a live walkthrough</Link>
        ...
        <Container>
          <Reveal>
            <div className="bg-card border border-border p-8 md:p-12 rounded-2xl max-w-3xl mx-auto text-center">
              ...
              <Link to="/contact?interest=Build" className="btn-pill btn-pill--primary inline-flex text-sm">Talk about a Build</Link>
            </div>
          </Reveal>
        </Container>
      </section>
