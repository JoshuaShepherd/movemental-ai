        ...
        <Container>
          <Reveal>
            ...
            <div className="hero-actions flex flex-wrap gap-4">
              <Link to="/field-guide" className="btn-pill bg-[#FDFBF7] text-[#101828] hover:bg-[#E5E0D8]">Read the field guide</Link>
            ...
            <div className="mt-12 flex items-center gap-3 border-t border-inverse-border/30 pt-6 max-w-2xl">
               ...
               <Link to="/movement-leaders" className="text-inverse-foreground hover:text-white text-sm font-medium hover:underline flex items-center gap-1 group">
        ...
        <Container>
          <Reveal>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 bg-section p-2 rounded-xl">
               <Link to="/nonprofits" className="bg-card border border-border hover:border-primary p-8 rounded-lg shadow-sm group">
               ...
               <Link to="/churches" className="bg-card border border-border hover:border-primary p-8 rounded-lg shadow-sm group">
               ...
               <Link to="/institutions" className="bg-card border border-border hover:border-primary p-8 rounded-lg shadow-sm group">
        ...
        <Container>
          <Reveal>
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-border max-w-[640px]">
               <Link to="/movement-leaders" className="btn-pill btn-pill--ghost">Read the definition</Link>
               <Link to="/voices" className="btn-pill btn-pill--ghost">See the trusted voices</Link>
            </div>
          </Reveal>
        </Container>
      </section>
        ...
        <Container width="narrow">
          <Reveal>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/assess" className="btn-pill border border-inverse-border text-inverse-foreground hover:bg-inverse-foreground/10">Take the diagnostic</Link>
            </div>
          </Reveal>
        </Container>
      </section>
