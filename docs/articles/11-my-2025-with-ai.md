---
title: "Chapter 11: My 2025 with AI"
slug: 11-my-2025-with-ai
shape: guide
...
You do not need a tour of every model release in 2025. You need one sustained example where the stakes were real: money, relationships, first-order moral judgment, time, reputation.
...
The work did not start with AI "being creative." It started with **human-authored work** that had to become structured, searchable, and usable—books as MDX and database rows, articles ingested through deterministic scripts, talks and recorded teaching transcribed so they could be cited and searched. AI helped where scale demanded it—translation jobs, transcription, batch processing—but the operating rule was simple: **the corpus is authority**. If we treat machine-generated text as if it were the author's life work, we have already lost the plot.
...
Core teaching judgment was not outsourced to a chat window. When AI suggested language that smoothed a hard edge, the right move was often to **reject the smoothness**—because the author's moral voice is sometimes supposed to be jagged.
...
- **Voice preservation:** Rubrics and checks only work if humans keep saying, "That sentence is grammatically fine and thin when you press it for evidence or fit."
...
Your context is not mine. You may never build a platform. You may need policies, a board, a communications director, a grant compliance officer—real constraints I did not have in the same form.
...
Next, we talk about pace—because once you see what AI can do, the temptation is either to sprint until you break or to freeze until you disappear. Neither posture **earns the trust** your people need from you.
