...
**Editorial workspace (canonical for drafting):** `docs/book-development/manuscript-ordered/` — each outline chapter maps to one markdown file: `00-preface-the-story.md`, then `01-…` through `21-…`, plus **`10a-the-scenius-at-scale-movemental-at-100.md`** (insert chapter **10A** between chapters 10 and 11; see “Chapter list at a glance” below). **Stable constraints and voice:** [`BOOK_META_OVERVIEW.md`](./BOOK_META_OVERVIEW.md), [`BOOK_VOICE_AND_STYLE_GUIDE.md`](./BOOK_VOICE_AND_STYLE_GUIDE.md). **Cohesion, dependencies, and agent protocol:** [`EDITING_AND_AGENT_GUIDE.md`](./EDITING_AND_AGENT_GUIDE.md). **Agent: publisher-quality edit (any chapter):** [`../../build/prompts/book-chapter-publisher-quality-edit.md`](../../build/prompts/book-chapter-publisher-quality-edit.md). Deeper research guardrails and per-chapter drafting prompts: [`../CANONICAL_BOOK_DRAFTING_SYSTEM.md`](../CANONICAL_BOOK_DRAFTING_SYSTEM.md).
...
- **“My 2025 with AI”** comes *after* the full framework (amplifier, amplification, maturity, experimentation, voice, scenius, transparency) **and** the architectural bridge (**chapter 10A**: scenius at scale / Movemental at ~100). It then works as the chapter that shows the framework in practice—the strongest use case. So: Who is speaking (story, guide) → Framework (all concepts) → **10A** (infrastructure sketch) → **My 2025 with AI** (framework in action).
...
- **Chapter 10A — The scenius at scale (Movemental at ~100)** (file `10a-the-scenius-at-scale-movemental-at-100.md`): Architectural sketch between disclosure and the year-in-review case study—multi-tenant graph, linking, formation, analytics, bounded AI—bridging chapter nine’s credibility pattern to chapter eleven’s lived build.

**Result**: 22 chapters + preface, in 7 parts. Tighter sequence, fewer redundant beats; insert chapter 10A plus the closing “Where I am now” chapter.
...
- Where you started (didn’t know anything; diagnostic reality). What it became: tool → machine → system → platform → multi-tenant vision (Alan Hirsch, Brad Brisco, and others). The crisis point (October; AI psychosis / 80% forever); the friend and the video; the turning point (rethinking everything, type-safety chain). What you realize now: wrong multiple times; didn’t “figure it out”; staying and still learning. Invitation: if this person didn’t know and stayed, maybe you can stay too.
...
**Function**: Give readers the shared vocabulary and mental model. After disclosure, name how infrastructure can hold scenius at bounded scale (**chapter 10A**). End Part III with the framework in practice (**My 2025 with AI**).
...
- **File:** `10a-the-scenius-at-scale-movemental-at-100.md` (insert between chapters 10 and 11; not a renumber of subsequent files).
- **Function:** Bridge from theory (scenius, disclosure) to case study (chapter 11). Architectural, not promotional: content as infrastructure; multi-tenant + shared knowledge graph; linking and canonical emergence; collaboration and cohort formation; analytics toward formation; AI inside rails; translation; honest limits (~100 as curation choice, graphs gameable).
- **Voice:** Same restraint as chapter nine—comparative trust claims, no hype.
...
*Rationale: Chapter 10A gives the structural “how” at scale; this chapter closes Part III so the framework lands in a real, detailed example before we move to discernment and boundaries.*
...
| 10A | The scenius at scale: Movemental at ~100 (`10a-…md`) |
| 11 | My 2025 with AI |
...
**Total: 22 chapters + preface** (including insert **10A**; manuscript file `10a-the-scenius-at-scale-movemental-at-100.md`).
