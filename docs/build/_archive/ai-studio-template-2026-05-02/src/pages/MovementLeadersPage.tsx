        ...
        <Container>
          <Reveal>
            ...
            <div className="hero-actions flex flex-wrap gap-4 mb-16">
              <Link to="/voices" className="btn-pill bg-[#FDFBF7] text-[#101828] hover:bg-[#E5E0D8]">See the named voices</Link>
            ...
            <aside className="border border-border-soft bg-card p-8 rounded-card max-w-3xl relative overflow-hidden">
               ...
               <div className="prose max-w-none text-muted-foreground text-[0.98rem] leading-relaxed relative z-10 flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-border-soft">
                     <Link to="/voices" className="text-primary font-medium hover:underline inline-flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-primary inline-block"></span> Trusted voices page</Link>
                     <Link to="/who-we-serve" className="text-primary font-medium hover:underline inline-flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-primary inline-block"></span> Who we serve</Link>
                  </div>
               </div>
            </aside>
          </Reveal>
