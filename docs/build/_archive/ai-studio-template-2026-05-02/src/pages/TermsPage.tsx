    ...
    <div className="py-24">
      <Container width="narrow">
        <div className="prose prose-neutral max-w-none">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4">Separate agreements</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
             For any questions regarding these Terms, please reach out via our <Link to="/contact" className="text-primary hover:underline">Contact page</Link>.
          </p>
        </div>
      </Container>
    </div>
