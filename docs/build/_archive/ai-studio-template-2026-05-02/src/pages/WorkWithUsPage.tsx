        ...
        <Container>
          <Reveal>
            ...
            <div className="grid md:grid-cols-3 gap-6">
               <Link to="/churches" className="group bg-card border border-border p-8 rounded-card hover:-translate-y-0.5 transition-transform">
               ...
               <Link to="/nonprofits" className="group bg-card border border-border p-8 rounded-card hover:-translate-y-0.5 transition-transform">
               ...
               <Link to="/institutions" className="group bg-card border border-border p-8 rounded-card hover:-translate-y-0.5 transition-transform">
      ...
      <section className="band-section" id="model">
        <Container>
          <Reveal>
            ...
            <Link to="/path" className="btn-pill btn-pill--ghost">See the full path</Link>
          </Reveal>
        </Container>
      </section>
      ...
      <section className="band-default" id="first-step">
        <Container>
          <Reveal>
            ...
            <Link to="/start-with-safety" className="btn-pill btn-pill--primary">Begin with Safety</Link>
          </Reveal>
        </Container>
      </section>
          ...
          <Reveal>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
               <div className="bg-card border border-border p-8 rounded-card flex flex-col">
                  ...
                  <Link to="/contact" className="btn-pill btn-pill--ghost w-full text-center mt-auto">Discuss a Safety Session</Link>
               </div>
               ...
               <div className="bg-card border-2 border-primary/20 p-8 rounded-card flex flex-col relative">
                  ...
                  <Link to="/contact" className="btn-pill btn-pill--primary w-full text-center mt-auto bg-foreground text-background">Explore Guided Pathway</Link>
               </div>
               ...
               <div className="bg-card border border-border p-8 rounded-card flex flex-col">
                  ...
                  <Link to="/contact" className="btn-pill btn-pill--ghost w-full text-center mt-auto">Discuss Solutions</Link>
               </div>
            </div>
          </Reveal>
        </Container>
