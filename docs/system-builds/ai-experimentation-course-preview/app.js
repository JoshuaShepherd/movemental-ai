(function () {
  ...
  if (!Array.isArray(lessons) || lessons.length === 0) {
    document.getElementById("lesson-root").innerHTML =
      "<p>Course content failed to load. Ensure all <code>ai-lessons-*.js</code> files are present.</p>";
    return;
  }
  ...
  function groupLabel(key) {
    var map = {
      start: "Start here",
      w1: "Week 1 — Orientation",
      w2: "Week 2 — Experimentation",
      w3: "Week 3 — Concerns",
      w4: "Week 4 — Integration",
      more: "Reference & appendices",
    };
    return map[key] || key;
  }
  ...
  function render(id) {
    ...
    setActiveNav(id);
    document.title =
      (L.h1 || L.title) + " — AI Safe Experimentation (Preview)";
    root.focus();
  }
