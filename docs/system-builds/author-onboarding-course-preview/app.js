(function () {
  ...
  if (!Array.isArray(lessons) || lessons.length === 0) {
    document.getElementById("lesson-root").innerHTML =
      "<p>Course content failed to load. Ensure all <code>course-lessons-*.js</code> files are present.</p>";
    return;
  }
  ...
  function groupLabel(key) {
    var map = {
      start: "Start here",
      w1: "Week 1 — Vision and Voice",
      w2: "Week 2 — Evergreen Articles",
      w3: "Week 3 — Courses & Assessments",
      w4: "Week 4 — Integration & Launch",
      more: "Reference",
    };
    return map[key] || key;
  }
  ...
  function render(id) {
    ...
    setActiveNav(id);
    document.title = (L.h1 || L.title) + " — Movemental Author Residency";
    root.focus();
  }
