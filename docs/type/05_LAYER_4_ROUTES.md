...
**Layer**: 4 of 6  
**Directory**: `src/app/api/simplified/` (+ hand-written routes under `src/app/api/`)  
**Validation**: `pnpm routes:check` → required `{"status":"VALIDATED"}`  
**Status**: ✅ **VALIDATED** — 215 generated CRUD routes (verified 2026-06-13)  
**Generate**: `pnpm generate:routes` (`scripts/generate-routes.ts`)
...
### `src/app/api/simplified/onboarding-responses/route.ts`

```typescript
import { NextRequest, NextResponse } from 'next/server';
import { onboardingResponsesService } from '@/src/lib/services/simplified/onboardingResponses';
import {
...
### `src/app/api/simplified/onboarding-responses/complete/route.ts`
...
- Import types and schemas from `src/lib/schemas/`
