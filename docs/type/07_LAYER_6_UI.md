...
**Validation**: `pnpm typecheck` (this repo has **no** `ui:check` script)  
**Status**: Not generated or layer-validated — components consume Layer 5 hooks  
**Design chain**: [`../design/INK_BAND_DESIGN_CHAIN.md`](../design/INK_BAND_DESIGN_CHAIN.md) (orthogonal but required for UI work)
...
```typescript
import { useOnboardingResponse } from '@/src/hooks/simplified/useOnboardingResponse';
...
import { useUpdateOnboardingResponse } from '@/src/hooks/simplified/useOnboardingResponse';
...
```typescript
import { useEntities } from '@/src/hooks/simplified/useEntities';
...
```typescript
import { useEntity } from '@/src/hooks/simplified/useEntity';
...
```typescript
import { useCreateEntity } from '@/src/hooks/simplified/useEntity';
import { useForm } from 'react-hook-form';
import { zodResolver } from '@hookform/resolvers/zod';
...
- Import types from `src/lib/schemas/`
