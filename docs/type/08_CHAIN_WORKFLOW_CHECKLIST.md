...
|-------------------|-------|-----------|
| `src/lib/db/schema.ts` | 1 | First |
| `src/lib/schemas/*.ts` | 2 | Second |
| `lib/services/**/*.ts` | 3 | Third |
| `src/app/api/simplified/**/*.ts` | 4 | Fourth |
| `src/hooks/simplified/*.ts` | 5 | Fifth |
...
**File**: `src/lib/services/simplified/newEntity.ts`
...
**Files**:
- `src/app/api/simplified/new-entity/route.ts` (GET list, POST create, PATCH update)
- `src/app/api/simplified/new-entity/[id]/route.ts` (GET detail, DELETE)

**Pattern**: Follow existing route patterns (see [05_LAYER_4_ROUTES.md](./05_LAYER_4_ROUTES.md))

```typescript
import { NextRequest, NextResponse } from 'next/server';
import { newEntityService } from '@/src/lib/services/simplified/newEntity';
...
**File**: `src/hooks/simplified/useNewEntity.ts`
...
```typescript
import { useNewEntities } from '@/src/hooks/simplified/useNewEntity';
...
|-------|---------------|---------|
| 1 | `src/lib/db/schema.ts` | Database schema |
| 2 | `src/lib/schemas/index.ts` | Entity Zod schemas |
| 2 | `src/lib/schemas/base.ts` | Base schemas |
| 2 | `src/lib/schemas/*.ts` | Domain-specific schemas |
| 3 | `src/lib/services/simplified/` | Entity services |
| 3 | `lib/services/simplified-base.ts` | Base service class |
| 3 | `lib/services/types.ts` | Result<T>, ServiceError |
| 4 | `src/app/api/simplified/` | API routes |
| 5 | `src/hooks/simplified/` | React hooks |
