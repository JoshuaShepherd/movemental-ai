...
**Directory**: `src/app/api/simplified/`
...
**Schema**: `src/lib/db/schema.ts` - `organizations` table
...
| Entity Schemas | `src/lib/schemas/index.ts` |
| Services | `src/lib/services/simplified/` |
| Routes | `src/app/api/simplified/` |
| Hooks | `src/hooks/simplified/` |
