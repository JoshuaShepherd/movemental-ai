    ...
    (function(){
      ...
      var input=document.querySelector('.chat-panel__input input');
    ...
    /* ----- Chat panel, hamburger, header scroll ----- */
    (function(){
    ...
    /* ----- Course learn sidebar toggle ----- */
    (function(){
      var toggle=document.getElementById('course-sidebar-toggle');
      var sidebar=document.getElementById('course-learn-sidebar');
      if(!toggle||!sidebar)return;
      toggle.addEventListener('click',function(){
