...
function resolveFromShared(raw) {
  ...
  set("RESEND_FROM_NAME", raw.RESEND_FROM_NAME || "Movemental");
  set("CONTACT_NOTIFY_EMAIL", raw.CONTACT_NOTIFY_EMAIL);
  set("NEWSLETTER_UNSUBSCRIBE_SECRET", raw.NEWSLETTER_UNSUBSCRIBE_SECRET);
