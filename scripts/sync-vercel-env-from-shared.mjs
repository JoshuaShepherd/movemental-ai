...
const MOVEMENTAL_RESOLVERS = [
  ...
  ["RESEND_FROM_NAME", (e) => e.RESEND_FROM_NAME || "Movemental"],
  ["CONTACT_NOTIFY_EMAIL", (e) => e.CONTACT_NOTIFY_EMAIL],
  ["NEWSLETTER_UNSUBSCRIBE_SECRET", (e) => e.NEWSLETTER_UNSUBSCRIBE_SECRET],
