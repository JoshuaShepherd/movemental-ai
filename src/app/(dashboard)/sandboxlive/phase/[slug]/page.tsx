      ...
      {fixture ? (
        ...
        <section className="mx-auto flex w-full max-w-3xl flex-col gap-4 px-6 py-16 md:px-12">
          ...
          <h2 className="font-serif text-[28px] italic leading-tight text-safestart-ink">
            This phase doesn&rsquo;t have a workspace fixture yet.
          </h2>
          <p className="text-[15px] leading-relaxed text-safestart-muted">
            The route is reachable so the navigation reads correctly, but the Stitch
            workspace for{" "}
            <strong className="font-medium text-safestart-ink">
              Phase {phase.number} — {phase.name}
            </strong>{" "}
            hasn&rsquo;t been authored. Until it lands, this is what the phase will
            produce:
          </p>
