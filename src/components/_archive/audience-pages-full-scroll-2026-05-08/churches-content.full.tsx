...
import { LightTextureHero } from "@/components/studio/hero/LightTextureHero";
...
function ChurchesHero() {
  return (
    <LightTextureHero
      headingId="churches-hero-h1"
      eyebrow="For churches"
      title="Your church is being asked to take a position on AI."
      subhead={
        <>
          <p>
            Whether the question came from your staff, your elders, your
            congregation, or your own conscience — it’s here, and it’s not
            going away. We help church leaders answer it well.
          </p>
          <p className="italic">
