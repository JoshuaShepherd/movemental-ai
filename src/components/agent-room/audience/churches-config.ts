...
export const CHURCHES_PAGE_CONFIG: AudiencePageConfig = {
  ...
  theCase: {
    ...
    askAiPrompt: `I'm reading Movemental's letter for churches (movemental.ai/agent/churches). Summarize the core argument, the four-stage path (Safety, Sandbox, Training, Tech), and what a credible first step would look like for a lead pastor. Note anything that needs verification.`,
  },
  foundation: {
    ...
    fixRows: [
      ...
      },
      {
        ...
        gain: "now there's a ratified handbook everyone can follow.",
      },
      {
  ...
  start: {
    ...
    askAiPrompt: `I'm reading Movemental's case for churches (movemental.ai/agent/churches). They argue AI is already inside church life, fragmentation is the deeper problem, and the path is Safety → Sandbox → Training → Tech — with a ratified AI Safety Handbook first.
