...
export const churchDeck: DeckData = {
  ...
  slides: [
    ...
    },
    {
      ...
      body: [
        "So when you hear the price, the first thought is: that's a lot for a church website. Hold that thought — because it's pointing at the wrong thing.",
      ],
    ...
    },
    {
      ...
      body: [
        "A visitor checks you out online before they ever walk in. A member wants last week's sermon and can't find it. Your best teaching evaporates the day after it's preached — surviving, if at all, as an un-searchable video. The wisdom of this church lives in a few heads instead of a place anyone can return to.",
  ...
  diagram: {
    ...
    captions: {
      site: "Just a site. A website builder gives you the surface — pages, hosting, a give button — and leaves the part that matters to you. Sharing your teaching, reaching your community, lightening your team's load: all on you.",
      home: "A platform. Movemental gives you the same site — and the system underneath. Your teaching shared well, tools built for your team, a community that knows you're here, and a presence the AI can represent faithfully.",
    },
