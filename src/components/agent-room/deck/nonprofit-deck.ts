...
export const nonprofitDeck: DeckData = {
  ...
  slides: [
    ...
    },
    {
      ...
      body: [
        "So when you hear the price, the first thought is: that's a lot to pay for a website. Hold that thought. It's pointing at the wrong thing.",
      ],
    ...
    },
    {
      ...
      body: [
        "You're finally able to afford the platform your mission always needed. The cost of building it just came down.",
  ...
  diagram: {
    ...
    captions: {
      site: "Just a site. WordPress gives you the pages, hosting, and a donate button, and leaves the part that matters to you. Telling your story well, lightening your staff's load, being understood: all on you.",
