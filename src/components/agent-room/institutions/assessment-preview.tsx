...
/**
 * In-context product artifact for institutions — a trimmed charter spread plus
 * dashboard framing (not the abstract node graph alone).
 */
export function InstitutionsAssessmentPreview() {
