 ...
 *
 * Static, scannable 4-stage layout (Stitch 5/10 reference, lines 234–308 of
 * `docs/html/stitch-5-10.html`). Stage 01 is the "boxed feature" — the
 * recommended starting point — and gets its own ink hairline border, large
 * serif-italic numeral, and primary CTA. Stages 02–04 are smaller parallel
 * columns with a hairline rule under each numeral and right-side dividers
 * between columns at desktop / bottom dividers between rows on mobile.
 *
 * Design notes:
 *   – Cream paper background (page default), not an alt band.
 *   – Numerals use serif italic (`font-serif italic`) to read as editorial
 *     marks rather than UI counters. Hierarchy comes from size + opacity:
 *     Stage 01 numeral is full-ink at clamp(72px, 12vw, 120px); stages 02–04
 *     are at ~64px in `text-foreground/30`. The amber accent in the Stitch
 *     mock is intentionally not ported — DESIGN.md reserves the amber
 *     register for the citation system.
 *   – Buttons are rectangular (no rounded pill) to honor the Stitch
 *     editorial register on this fold; the rest of the site keeps its pill
 *     CTAs. This is a deliberate local departure for visual weight.
 *   – Citation chip and HumanHighlight from the prior tabbed version are
 *     preserved verbatim in the intro paragraph.
 */
      ...
      <div className="mx-auto max-w-(--container-max)">
        ...
        <div className="mb-16 grid grid-cols-1 lg:grid-cols-12 lg:mb-20">
          ...
          <div className="flex flex-col border border-border p-8 md:p-10 lg:col-span-4">
            ...
            <p className="mb-8 font-serif text-[13px] italic text-muted-foreground">
              $1,000 · two weeks · seven deliverables.
            </p>
        ...
        <div className="mb-16 border border-border bg-section/50 p-8 md:mb-20 md:p-10">
          <p className="max-w-3xl font-serif text-lg italic leading-relaxed text-foreground md:text-xl">
            Two weeks of facilitated work that produces seven board-ratifiable
            governance documents your leadership can sign and your team can
            follow.
          </p>
          <div className="mt-10 grid gap-10 md:grid-cols-3 md:gap-8">
            <div>
              ...
              <ul className="m-0 space-y-3 p-0 text-sm leading-relaxed text-muted-foreground md:text-[15px]">
                <li className="pl-0">
                  Acceptable Use Statement and Named Refusals
                </li>
                <li className="pl-0">
                  Care Boundaries and Data Handling Protocol
                </li>
                <li className="pl-0">
                  Vendor Inventory and Incident Response Plan
                </li>
                <li className="pl-0">Disclosure Standards</li>
              </ul>
            </div>
            <div>
              <p className="mb-4 text-[11px] font-medium uppercase tracking-eyebrow text-muted-foreground">
