...
const STAGE_OFFERINGS: readonly StageOffering[] = [
  {
    ...
    priceLine: "$2,500",
    subPrice: "Field Guide free",
    body: "Two-week facilitated MVP. One 60–90 minute leadership conversation. Seven ratifiable artifacts produced and customized to your organization. The free Field Guide is the downloadable toolkit version for organizations that prefer to run the work themselves.",
    whatYouGet: [
      "AI Use Charter",
      ...
      "Communication to the Constituent Base",
    ],
    payment: "Net 15 from signing.",
    ctaLabel: "Begin Safety",
    ctaHref: "/contact?interest=safety-mvp",
  },
  {
