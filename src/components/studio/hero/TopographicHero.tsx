...
interface TopographicHeroProps {
  /**
   * When true, the terrain image is omitted from mobile (<lg) viewports to
   * prioritize text legibility. Defaults to false (image rendered as an
   * ambient close to the section on mobile, per spec option (a)).
   */
    ...
    >
      <Container>
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="relative z-10 lg:col-span-7">
            <Reveal>
              ...
              <div className="mt-10 flex flex-col gap-3 md:flex-row md:gap-4">
                <Link
                  href="/pathway"
                  className="motion-safe:hover:-translate-y-0.5 inline-flex items-center justify-center rounded-full bg-[#F0EBE0] px-7 py-3.5 text-base font-medium text-[#0E1726] transition-transform duration-200 ease-out"
                >
                  See the Path
                </Link>
                <Link
          ...
          {/*
            Right column on desktop; ambient close on mobile.
            On lg+ the image bleeds off the right edge of the viewport via a
            negative right offset and a 120% width.
          */}
          <div
            ...
            aria-hidden="true"
          >
            <div className="relative mx-auto aspect-[16/10] w-full opacity-30 md:max-w-[560px] lg:absolute lg:inset-y-0 lg:right-[-12%] lg:my-auto lg:h-[110%] lg:w-[120%] lg:max-w-none lg:opacity-30">
              <Image
