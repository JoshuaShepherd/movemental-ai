    ...
    <div className="py-24">
      <Container width="narrow">
        <div className="prose prose-neutral max-w-none">
          ...
          <h2 className="text-xl mt-8 mb-4">What are cookies?</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl mt-8 mb-4">How we use cookies</h2>
          ...
          <h2 className="text-xl mt-8 mb-4">Third-party cookies</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl mt-8 mb-4">Updates to this policy</h2>
          <p className="mb-4">
