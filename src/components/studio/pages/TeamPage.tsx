        ...
        <Container>
          <Reveal>
            ...
            <p className="border-l-2 border-foreground pl-5 max-w-[50ch] text-[1.0625rem] leading-[1.75] text-foreground font-medium py-2 my-10">
               <Link href="/voices" className="group inline-flex items-center gap-1.5 border-b border-border pb-0.5 text-foreground hover:border-foreground transition-colors">
                  See trusted voices
