        ...
        <Reveal>
          <div className="max-w-4xl mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
              <Link href="/contact?interest=Foundations" className="btn-pill btn-pill--primary">Start with Foundations</Link>
            </div>
          ...
          <Reveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link href="/pathway/lab" className="btn-pill btn-pill--ghost">Explore Mile Marker 02: Lab</Link>
                <Link href="/contact?interest=Foundations" className="btn-pill btn-pill--primary">Ready to start Foundations?</Link>
              </div>
            </div>
          </Reveal>
        </Container>
