...
export const FAQ_SECTIONS: readonly FaqSection[] = [
  {
    ...
    items: [
      ...
      { q: "Is this a tool, a course, or a consulting engagement?", a: "It is a consulting engagement mapped to a specific architecture. See Ways to Engage on the Contact page." },
      ...
      { q: "Do we need to have an AI strategy already?", a: "No. We help you build a durable system rather than a fragile temporary strategy." },
    ],
  },
  {
    ...
    items: [
      { q: "What is the Movemental Path?", a: "Movemental’s public methodology — four stages in order: Safety, Sandbox, Training, Tech. Read the Path summary for the full arc." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Is this primarily a technology problem?", a: "No. It is an adaptive leadership and formation challenge masquerading as a technology shift." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do you build custom assistants?", a: "Yes, during the Tech stage, but only after human oversight protocols are thoroughly defined and tested." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Where are your case studies?", a: "Named case studies are in development. In the meantime: the field guides (what we teach), the movement leaders directory (who walks alongside this work), and the founders’ longer arc on About. Specific named clients come once we have permission to publish them, not before." },
      { q: "Why doesn’t your site have a logo wall?", a: "We do not show client logos without explicit permission, and the kind of trust this work requires is not transferred by brand association. The proof is the structural integrity of the system we deliver." },
