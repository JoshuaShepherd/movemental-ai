...
export const FAQ_SECTIONS: readonly FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What do Training and Tech include?", a: "Training forms human judgment. Tech is building AI into your actual workflows, only after safety and skill are in place." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do you build custom assistants?", a: "Yes, during the Tech stage, but only after clear review rules are defined and tested." },
