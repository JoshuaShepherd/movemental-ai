 ...
 * so "book" vs "AI Stewardship Sequence field guide" never drift to the wrong href.
 */
...
/**
 * Compiled AI Stewardship Sequence field guide (Safety, Sandbox, Skills, Solutions).
 ...
 * user-visible label is "AI Stewardship Sequence field guide."
 */
