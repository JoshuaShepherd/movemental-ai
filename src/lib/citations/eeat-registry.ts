 ...
 * `/field-guide`. This entry keeps that tooltip wired without splitting the map.
 */
...
/** Inline Antiqua et Nova chip on `/field-guide` — row lives off the home JSON bundle. */
